                    ...
                    <div className="space-y-4">
                      ...
                      <form onSubmit={handleEmailSubmit}>
                        <div className="relative">
                          ...
                          <motion.button
                            type="submit"
                            className="absolute right-1.5 top-1.5 text-white w-9 h-9 flex items-center justify-center rounded-full bg-transparent hover:bg-white/10 transition-colors shadow-md"
