...
function InteractiveHero({ isNavOnly = false }: InteractiveHeroProps) {
  ...
  const imageVariants: Variants = {
    ...
    visible: {
      ...
      scale: 1,
      y: 0,
      transition: { duration: 0.6, delay: contentDelay + itemDelayIncrement * 4, ease: [0.16, 1, 0.3, 1] },
    },
  }
    ...
    <div
      className={
        isNavOnly
          ...
          : "pt-[100px] relative bg-[#111111] text-gray-300 min-h-screen flex flex-col overflow-x-hidden"
      }
    >
      {!isNavOnly && <canvas ref={canvasRef} className="absolute inset-0 z-0 pointer-events-none opacity-80" />}
      {!isNavOnly && (
        <div
      ...
      >
        <nav className="flex justify-between items-center max-w-screen-xl mx-auto h-[70px]">
          ...
          <div className="hidden md:flex items-center justify-center mx-auto space-x-8 lg:space-x-12">
          ...
          <div className="flex items-center flex-shrink-0 space-x-4 lg:space-x-6">
            ...
            <motion.a
              href="/signup"
              className="hidden md:inline-flex bg-white text-[#111111] px-4 py-[6px] rounded-md text-sm font-semibold hover:bg-white/90 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-md"
          ...
          {isMobileMenuOpen && (
            ...
            >
              <div className="flex flex-col items-center space-y-4 px-6">
                ...
                <NavLink onClick={() => setIsMobileMenuOpen(false)}>Documentation</NavLink>
                <NavLink href="/pricing" onClick={() => setIsMobileMenuOpen(false)}>
                  Pricing
                </NavLink>
                <NavLink href="/careers" onClick={() => setIsMobileMenuOpen(false)}>
                  Careers
                </NavLink>
                <NavLink href="/blog" onClick={() => setIsMobileMenuOpen(false)}>
                  Blog
                </NavLink>
        ...
        <main className="flex-grow flex flex-col items-center justify-center text-center px-4 pt-8 pb-16 relative z-10">
          <motion.div variants={bannerVariants} initial="hidden" animate="visible" className="mb-6">
            <ShinyText
              ...
              className="bg-[#1a1a1a] border border-gray-700 text-white px-4 py-1 rounded-full text-xs sm:text-sm font-medium cursor-pointer hover:border-white/50 transition-colors"
            />
          </motion.div>
          ...
          >
            Automate your API docs workflow
          </motion.h1>
          ...
          >
            Devscribe boosts your team's efficiency by automating and managing your API documentation with ease allowing
            readability for all.
          </motion.p>
          ...
          >
            <motion.button
              className="w-full sm:w-auto bg-white text-[#111111] px-6 py-3 rounded-md text-sm font-semibold hover:bg-white/90 transition-all duration-200 whitespace-nowrap shadow-sm hover:shadow-white/20 hover:shadow-lg flex-shrink-0"
              whileHover={{ scale: 1.03, y: -1 }}
              whileTap={{ scale: 0.97 }}
              transition={{ type: "spring", stiffness: 400, damping: 15 }}
            >
            ...
            <motion.button
              className="w-full sm:w-auto bg-transparent text-white border border-white/50 px-6 py-3 rounded-md text-sm font-semibold hover:bg-white/10 transition-colors duration-200 whitespace-nowrap shadow-sm hover:shadow-white/20 hover:shadow-lg flex-shrink-0"
              whileHover={{ scale: 1.03, y: -1 }}
              whileTap={{ scale: 0.97 }}
              transition={{ type: "spring", stiffness: 400, damping: 15 }}
            >
          ...
          >
            <div className="relative w-full aspect-video rounded-lg shadow-xl border border-gray-700/50 overflow-hidden">
              <iframe
